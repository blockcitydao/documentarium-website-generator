    ...
    <section className="min-h-screen relative flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        >
          ...
          <h1 className="font-pixel text-3xl md:text-4xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 via-purple-300 to-pink-300 leading-relaxed">
            Block City DAO
          </h1>
          <p className="font-pixel-alt text-xl md:text-2xl mb-8 text-purple-100 max-w-3xl mx-auto">
